...
用法示例:
    ...
    uv run python scripts/manual/email_service_manual_test.py fetch --token "mailbox::abc@example.com"
    uv run python scripts/manual/email_service_manual_test.py fetch --token "mailbox::abc@example.com" --since-marker 1742895300456
"""
...
from app.config import EMAIL_POLL_INTERVAL, EMAIL_WAIT_TIMEOUT
